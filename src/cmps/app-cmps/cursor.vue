<template>
  <div
    class="work-together-mouse"
    v-for="cursor in cursorsData"
    :key="cursor"
    :style="{
      top: cursor.clientXY.clientY + 'px',
      left: cursor.clientXY.clientX + 'px',
    }">
    <svg
      v-if="cursor.type === 'down'"
